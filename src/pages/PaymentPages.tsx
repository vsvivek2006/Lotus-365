          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                ...
                {
                  q: 'Can I use UPI on Lotus365 without downloading an APK?',
                  a: 'Yes! Lotus365 is 100% web-based. You coordinate deposits directly via WhatsApp and play on lotus365officialid.com in your mobile browser without installing any third-party betting APK.'
                },
                {
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                ...
                {
                  q: 'Do I need an app or APK to withdraw my winnings?',
                  a: 'No app or APK is needed. Simply coordinate your withdrawal through your verified WhatsApp chat with our support team.'
                },
              ].map((faq, idx) => (
                <div key={idx} className="p-4 rounded-xl bg-black/20 border border-white/10">
                  <h4 className="font-bold text-white text-sm mb-2">{faq.q}</h4>
