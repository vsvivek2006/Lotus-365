...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({ onOpenAuth }) => {
  ...
  return (
    <nav
      ...
      className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#0E4737]/98 backdrop-blur-xl border-t border-white/20 px-2 pt-1.5 pb-[max(0.375rem,env(safe-area-inset-bottom))] shadow-[0_-8px_30px_rgba(0,0,0,0.85)]"
    >
